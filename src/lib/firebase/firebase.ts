...
//   clientLogger.debug('firebase', message, data || '');
// };
...
//     };
//   } catch (error) {
//     const errorMsg = clientLogger.error('firebase', 'Client initialization failed', error);
...
//           } catch (error) {
//             clientLogger.error('firebase', 'Failed to initialize Firebase Admin app', error);
//             return null;
//           }
//         } else {
...
//       return initAdminApp;
//     } catch (error) {
//       clientLogger.error('firebase', 'Error importing admin Firebase modules', error);
//       return null;
//     }
//   };
